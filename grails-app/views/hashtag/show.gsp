...
<html>
    ...
    <body>
        ...
        <div id="show-hashtag" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.hashtag}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.hashtag}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
